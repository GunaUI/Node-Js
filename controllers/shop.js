...
// don't need to install a package it's already included in node and the file system allows you to do things like read files 
const fs = require('fs');
...
exports.downloadInvoice = (req, res, next) => {
  ...
  Order.findById(orderId)
    .then(order => {
      ...
      // so I also pipe the output into my response
      pdfDoc.pipe(res);
